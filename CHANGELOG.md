...
*  `autorepeat-by-default` patch ([#148](https://github.com/someone5678/revanced-patches/issues/148)) ([fe628ba](https://github.com/someone5678/revanced-patches/commit/fe628ba909d89ea0bf3d95fe94ca78ef819677da))
* `auto-captions` patch switch description ([#488](https://github.com/someone5678/revanced-patches/issues/488)) ([7bcac4f](https://github.com/someone5678/revanced-patches/commit/7bcac4fb65ca5439dd5fb6a8fc269c90629a7f65))
* `codecs-unlock` patch and update Music patches to `5.14.53` ([2437d30](https://github.com/someone5678/revanced-patches/commit/2437d3070f6a630d353619f642cefebd47abee20))
* `create-button-signature` ([a173f6e](https://github.com/someone5678/revanced-patches/commit/a173f6e5a7e65943657e2072e8a72a4a680e5277))
* `custom-branding` patch failing to get resources ([efb6d4c](https://github.com/someone5678/revanced-patches/commit/efb6d4c2be515185fc9bd29c40ce202f0d684cee))
* `default-video-quality` patch crashing ([#227](https://github.com/someone5678/revanced-patches/issues/227)) ([379327a](https://github.com/someone5678/revanced-patches/commit/379327a6b2325ef93c7107472343dd9fd85a0f56))
* `disable-create-button` not working with prebuilt jar file ([#55](https://github.com/someone5678/revanced-patches/issues/55)) ([78be64a](https://github.com/someone5678/revanced-patches/commit/78be64accc2023281c0c376849cdb0213622dc5c))
* `enable-seekbar-tapping` patch ([52fd726](https://github.com/someone5678/revanced-patches/commit/52fd726d9b0d2efbd0f9742fc84ad01ccdcff168))
* `exclusive-audio-playback` patch ([#153](https://github.com/someone5678/revanced-patches/issues/153)) ([9beff95](https://github.com/someone5678/revanced-patches/commit/9beff9567f1586e5c58690c1f1d2f7f204025ab7))
* `hrd-auto-brightness` ([#152](https://github.com/someone5678/revanced-patches/issues/152)) ([5f2e9ba](https://github.com/someone5678/revanced-patches/commit/5f2e9ba30b7432be04bdc9f9f7ec7ac75fdc4b34))
* `Index` in wrong package ([2f9360f](https://github.com/someone5678/revanced-patches/commit/2f9360f57cc8415564534fbbd8bd5e2a83a1b629))
* `minimized-playback` & `old-quality-layout` wrong opcodes ([b45d175](https://github.com/someone5678/revanced-patches/commit/b45d175c6f1ece6da894ab16128c2644d262c9c7))
* `minimized-playback` patch ([55677a4](https://github.com/someone5678/revanced-patches/commit/55677a44ff965c0b92c3f1d771bd68c12c142ad4))
* `minimized-playback` patch for YouTube Kids videos ([#201](https://github.com/someone5678/revanced-patches/issues/201)) ([31e3b42](https://github.com/someone5678/revanced-patches/commit/31e3b42c6bbce0d00f049b8a69bafc94900bb3b4))
* `old-quality-layout` patch ([2497425](https://github.com/someone5678/revanced-patches/commit/2497425c9f11b8b14c861c2f0f34ff47bdbfac53))
* `Patch` annotation for `client-spoof` patch ([e9ab125](https://github.com/someone5678/revanced-patches/commit/e9ab125b042641da840a3fe8464c6cd34b9961eb))
* `seekbar-tapping` toggling ([#401](https://github.com/someone5678/revanced-patches/issues/401)) ([33ece5b](https://github.com/someone5678/revanced-patches/commit/33ece5bdb4ecd35cadc27023c04f7e17b1efa6e1))
* `SignatureChecker` not handling nullable field `methodMetadata` ([17bcf78](https://github.com/someone5678/revanced-patches/commit/17bcf786a85ccf1f7d9f5a66a044a3c26def09bb))
* `swipe-controls` with active engagement panel ([#177](https://github.com/someone5678/revanced-patches/issues/177)) ([000ec6d](https://github.com/someone5678/revanced-patches/commit/000ec6d8f6ecbb910a06ec852564ee9e5f03dcf8))
* accidentally removed code in refactor ([0077e26](https://github.com/someone5678/revanced-patches/commit/0077e26d23cc112b671a41614a55348fac2c88ca))
* actually call `VideoInformation.setCurrentVideoId` first ([5c62d0a](https://github.com/someone5678/revanced-patches/commit/5c62d0a2e0217de1b9563a41b4e94ed63230440f))
* add `patches.json` as a release asset ([60886bc](https://github.com/someone5678/revanced-patches/commit/60886bcdc218515d519e0bb14642800da13fb741))
* add 17.25.34 as supported version for swipe-controls patch ([4d84c19](https://github.com/someone5678/revanced-patches/commit/4d84c1914f8ecf51cee25667219bc6cf635a6c1c))
* add execute permission to `./gradlew` file ([ff7a560](https://github.com/someone5678/revanced-patches/commit/ff7a5602f68428111fea6c60cbea694592039ef1))
* add missing `trimIndent()` to string literals ([76d3c71](https://github.com/someone5678/revanced-patches/commit/76d3c71b67edebd79f2cdb1bb28e4d2969d72223))
* add missing opcode for `create-button-method` ([0a398ef](https://github.com/someone5678/revanced-patches/commit/0a398ef364f91a0dd9608df1a036a2515476ccf2))
* add missing permission to reboot app ([#260](https://github.com/someone5678/revanced-patches/issues/260)) ([6ced6df](https://github.com/someone5678/revanced-patches/commit/6ced6df8ed7642dea51e1acd1c12f4de4874b972))
* add missing switch for `tablet-mini-player` patch ([6f5104d](https://github.com/someone5678/revanced-patches/commit/6f5104d93471c8483a22e7c786321d220527ef90))
* add missing switch for tablet mini-player ([b824d35](https://github.com/someone5678/revanced-patches/commit/b824d35960df9e99c2a2d248356c3c9342cfe130))
* add size `48px` for `custom-branding` patch ([f81872b](https://github.com/someone5678/revanced-patches/commit/f81872b8e41da215517fdb59364130d8ce681607))
* add v17.28.34 compatiblity for the `hide-shorts-button` patch ([#224](https://github.com/someone5678/revanced-patches/issues/224)) ([76166bb](https://github.com/someone5678/revanced-patches/commit/76166bb35f940ef661e2802f5bf93ed91f2e2913))
* alignment of download button icon ([#477](https://github.com/someone5678/revanced-patches/issues/477)) ([2f046f9](https://github.com/someone5678/revanced-patches/commit/2f046f9cbe1c71b6e795b261b3bf80d0243dc1f7))
* **anytracker:** syntax error in fingerprint ([#1165](https://github.com/someone5678/revanced-patches/issues/1165)) ([81c7095](https://github.com/someone5678/revanced-patches/commit/81c7095d1a5fc16a56b419c1af180a5a068e4e68))
* apply multiple changes from integrations, refactor package structure, class names and implementations ([bc30e39](https://github.com/someone5678/revanced-patches/commit/bc30e39ae520b48e8b5c040685bef9ade944f492))
* attempt on all patches ([3395d69](https://github.com/someone5678/revanced-patches/commit/3395d69747103a4bdf314297aa0bfa6ef6a0fc36))
* autoplay not working. ([586eed5](https://github.com/someone5678/revanced-patches/commit/586eed515fc7ff8e3b1b150b0d34610b39480bb5))
* autoplay still enabled when using patch ([4f96129](https://github.com/someone5678/revanced-patches/commit/4f961298f6cb6417ee3f3d6f8ac7ce96594ed03b))
* breaking changes by `revanced-patcher` dependency ([e12e484](https://github.com/someone5678/revanced-patches/commit/e12e484e3796c5c9c8505b677838cdf8432f2e79))
* breaking changes by `revanced-patcher` dependency ([7e485b4](https://github.com/someone5678/revanced-patches/commit/7e485b4ffe204d724809aeb9bd9f693a35ded94d))
* breaking changes of the patcher ([1a49bbd](https://github.com/someone5678/revanced-patches/commit/1a49bbdbc4ff6f427934259536218e161908b449))
* breaking patcher changes ([50f9cc5](https://github.com/someone5678/revanced-patches/commit/50f9cc52acfd5bc23330ecd23d8d85678a9d3eee))
* breaking patcher changes ([cbb9e2c](https://github.com/someone5678/revanced-patches/commit/cbb9e2cd1fa829e1d1dd92dbd40131b11ae6a05b))
* breaking patcher changes ([581d1b0](https://github.com/someone5678/revanced-patches/commit/581d1b0ca7d15adcdb1ab6116ef035acfe701757))
* broken gradle task ([91483a8](https://github.com/someone5678/revanced-patches/commit/91483a8fbf92559d079dc52f846f5f871f5d6b5c))
* broken gradle task ([4d07961](https://github.com/someone5678/revanced-patches/commit/4d07961c8afd24da7f8879d11419147f2e100f05))
* broken gradle task ([28e3f55](https://github.com/someone5678/revanced-patches/commit/28e3f554ea6a7144416523fe48ce7adbb613b263))
* bugfixes in `microg` ([a43b33b](https://github.com/someone5678/revanced-patches/commit/a43b33bdbb2b36e0a8f991fa11dfeeec34de01f9))
* bump youtube version for swipe-controls patch ([ff207a5](https://github.com/someone5678/revanced-patches/commit/ff207a57af7d3c15a8127f4465e97da23878b0d6))
* bump youtube version to 17.27.39 ([b93401a](https://github.com/someone5678/revanced-patches/commit/b93401a391c0ed4887dd1376ac253f74f98a8d7e))
* bump youtube version to 17.28.34 ([#225](https://github.com/someone5678/revanced-patches/issues/225)) ([738cb6a](https://github.com/someone5678/revanced-patches/commit/738cb6af177e92bbff8c02d6808fe416c0ad2582))
* bump youtube version to 17.29.34 ([#236](https://github.com/someone5678/revanced-patches/issues/236)) ([be6494a](https://github.com/someone5678/revanced-patches/commit/be6494a80989044cba961dc22fc58ffb2e8591f0))
* change fingerprint to work on latest youtube ([#80](https://github.com/someone5678/revanced-patches/issues/80)) ([4dba323](https://github.com/someone5678/revanced-patches/commit/4dba323ddf8980cd2b0908a0de41c4b4dea6b0d7))
* changed default value for autorepeat setting ([#386](https://github.com/someone5678/revanced-patches/issues/386)) ([5c808b0](https://github.com/someone5678/revanced-patches/commit/5c808b032901a165ebbb765b8c302e33211475d4))
* check if node has attributes before accessing them ([2d2ed87](https://github.com/someone5678/revanced-patches/commit/2d2ed870dacfe092eb6acbcaae5e51775c611322))
* check if resource files exist ([ba1f3af](https://github.com/someone5678/revanced-patches/commit/ba1f3af99be58edc44ed1b8f1875508d5034efd8))
* clean after building ([a2df3fb](https://github.com/someone5678/revanced-patches/commit/a2df3fbc9761b07f3010542fa8684ade00e4dc91))
* cleanup & trigger release for ThemePatch ([161256a](https://github.com/someone5678/revanced-patches/commit/161256afd391d4d42ff64afb2cf9289b785ec29f)), closes [#447](https://github.com/someone5678/revanced-patches/issues/447) [revanced/revanced-patcher#99](https://github.com/revanced/revanced-patcher/issues/99)
* compatibility of `force-vp9-codec-parent-fingerprint` fingerprint with version `17.27.39` ([523fd86](https://github.com/someone5678/revanced-patches/commit/523fd8627bc965a724267f725c28fba5e7a25a04))
* constrain `old-quality-layout` to older version ([add7232](https://github.com/someone5678/revanced-patches/commit/add72326199e90f677b450b553b9d88c0bb4c490))
* correct title for `tablet-miniplayer` setting switch ([77db73d](https://github.com/someone5678/revanced-patches/commit/77db73d0e98d83e9c508b0b3c33a34b95a476048))
* crash when using force-vp9-codec patch ([7a35e5c](https://github.com/someone5678/revanced-patches/commit/7a35e5c985b412d5a84083d1416d3207a40b3e97))
* **custom-playback-speed:** implement own method instead of `takeWhile` ([3504912](https://github.com/someone5678/revanced-patches/commit/3504912eba0f7943a712df62e401d0e1caaa7a9e))
* **custom-video-buffer:** use correct offset for `getMaxBuffer` call injection ([cbc3aa6](https://github.com/someone5678/revanced-patches/commit/cbc3aa6c3816631a8cae7f7c44746f575b2851ce))
* default values for settings ([9025844](https://github.com/someone5678/revanced-patches/commit/9025844a881ea063a7c107ae9d952c0b07a2b74e))
* design language for download icon ([#464](https://github.com/someone5678/revanced-patches/issues/464)) ([a050405](https://github.com/someone5678/revanced-patches/commit/a050405249be293154f996413311f0321b5b3def))
* disable `hide-suggestions-patch` patch until fixed ([99099ea](https://github.com/someone5678/revanced-patches/commit/99099ea0bc12f5f25896967db642442df69d0c4f))
* disable cast modules in YouTube Music ([#337](https://github.com/someone5678/revanced-patches/issues/337)) ([86eaba8](https://github.com/someone5678/revanced-patches/commit/86eaba8248100987f46540a224956099bcf9da2c))
* **disable-auto-player-popup-panels:** swap switch toggle state description ([#653](https://github.com/someone5678/revanced-patches/issues/653)) ([d4c166c](https://github.com/someone5678/revanced-patches/commit/d4c166cd60e7be360334650ef9a619133f34e208))
* disable-fullscreen-panels patch not working ([#213](https://github.com/someone5678/revanced-patches/issues/213)) ([5372105](https://github.com/someone5678/revanced-patches/commit/5372105e72607f289b779e4c2a3c13f3458842ce))
* **disable-startup-shorts-player:** incorrect offsets, invert branch condition ([#672](https://github.com/someone5678/revanced-patches/issues/672)) ([95cb6e8](https://github.com/someone5678/revanced-patches/commit/95cb6e8836ada3245da59effb2900011a8ca506c))
* **disable-startup-shorts-player:** remove redundant opcode pattern ([#679](https://github.com/someone5678/revanced-patches/issues/679)) ([5e74f61](https://github.com/someone5678/revanced-patches/commit/5e74f61a74104cd7cdf17b83647a30b3d8386717))
* display codename for patch names ([10c53f7](https://github.com/someone5678/revanced-patches/commit/10c53f720df3e70b9d59e8bc3219d56b996f03db))
* do not constrain `amoled` patch to versions ([#408](https://github.com/someone5678/revanced-patches/issues/408)) ([dfff01a](https://github.com/someone5678/revanced-patches/commit/dfff01a27704262c85a3d0d04609a79fa9d0491b))
* don't overwrite register in `compact-header` patch ([#406](https://github.com/someone5678/revanced-patches/issues/406)) ([7004b30](https://github.com/someone5678/revanced-patches/commit/7004b30ef9329f02cb61973d65410f9410f1e05c))
* don't respect primary color for the download button icon ([#424](https://github.com/someone5678/revanced-patches/issues/424)) ([f82500b](https://github.com/someone5678/revanced-patches/commit/f82500b921b148e56a8ce699f7b52fc5dc020e7e))
* dummy task for Gradle semantic-release plugin ([f6a8911](https://github.com/someone5678/revanced-patches/commit/f6a8911906dfe52fcdb685daf7a02d6d0052cba9))
* environment variable not found in gradle build script ([0da15fb](https://github.com/someone5678/revanced-patches/commit/0da15fb0effac0566d080d7b85e9fbe46c3dd34d))
* exclude `swipe-controls` by default due to instability ([bdeb8e0](https://github.com/someone5678/revanced-patches/commit/bdeb8e04609a0ca94d9e2921bf7d486b9e229cec))
* forgot about this ([7102a25](https://github.com/someone5678/revanced-patches/commit/7102a25dc618f19b324b01870d23f5418f375b2a))
* freezing panels when watching video in fullscreen ([#89](https://github.com/someone5678/revanced-patches/issues/89)) ([f5d4f6c](https://github.com/someone5678/revanced-patches/commit/f5d4f6c3419916c6a9cf67babc6be8a64c854d3b))
* **general-ads:** invalid smali syntax ([30e8554](https://github.com/someone5678/revanced-patches/commit/30e8554729a1ca32c0d0274d93928f482bce707b))
* get create button view register by more reliable means ([#59](https://github.com/someone5678/revanced-patches/issues/59)) ([6ab821e](https://github.com/someone5678/revanced-patches/commit/6ab821e377176f4e9f1b7ec2b58a924fa40299db))
* **hdr-auto-brightness:** increase patching compatibility across versions ([f883e72](https://github.com/someone5678/revanced-patches/commit/f883e72dce416eec45aced2948a3b5b4bd3e6d8d))
* **hdr-brightness:** trim list of compatible versions ([#602](https://github.com/someone5678/revanced-patches/issues/602)) ([ce2d18c](https://github.com/someone5678/revanced-patches/commit/ce2d18cf4b067c731b35a55e0581ebb8c26f0cc1))
* **hide-create-button:** increase patching compatibility across versions ([99800ac](https://github.com/someone5678/revanced-patches/commit/99800ac558deec5035ba94254ea6595e569d4c42))
* **hide-email-address:** invalid instruction offsets ([#654](https://github.com/someone5678/revanced-patches/issues/654)) ([93d47cc](https://github.com/someone5678/revanced-patches/commit/93d47cc9c70ef08696581db94905841473205ed4))
* **hide-premium-nav-bar:** invalid import ([#590](https://github.com/someone5678/revanced-patches/issues/590)) ([c38717f](https://github.com/someone5678/revanced-patches/commit/c38717f79eec5c050eb826be61a9e20153edde73))
* **hide-premium-navbar:** remove the correct instructions ([#591](https://github.com/someone5678/revanced-patches/issues/591)) ([368b36c](https://github.com/someone5678/revanced-patches/commit/368b36cb488cc112adcb269aec15e4306d98abce))
* **hide-shorts-button:** increase patching compatibility across versions ([e3b3280](https://github.com/someone5678/revanced-patches/commit/e3b32800ffb8af6127c107d86d93aab04b54d3fb))
* **hide-time-and-seekbar:** don't draw the seekbar ([#594](https://github.com/someone5678/revanced-patches/issues/594)) ([4a4f883](https://github.com/someone5678/revanced-patches/commit/4a4f8836c52db208ea428c561024163482011029))
* inconsistencies in preference switches ([#1207](https://github.com/someone5678/revanced-patches/issues/1207)) ([b6ea5a4](https://github.com/someone5678/revanced-patches/commit/b6ea5a43b3eec6a06c7514cd79569b97a2b7d333))
* incorrect compatibilty attribute ([#296](https://github.com/someone5678/revanced-patches/issues/296)) ([0ab3e97](https://github.com/someone5678/revanced-patches/commit/0ab3e9724157c628555964273c6b65f9f48f9664))
* incorrect endIndex (fixed in Patcher) ([424788e](https://github.com/someone5678/revanced-patches/commit/424788edd777110cdaff97500556d18628f33385))
* incorrect fingerprint version [skip ci] ([f8c62ae](https://github.com/someone5678/revanced-patches/commit/f8c62ae16b088ff6d0e96a4ef62dc707cd83beb9))
* incorrect package name in gradle task ([152b2c9](https://github.com/someone5678/revanced-patches/commit/152b2c90cf102170648fcc168da10f46743bdc63))
* invalid regex ([26bf1d8](https://github.com/someone5678/revanced-patches/commit/26bf1d818f953abc061126d8b91f17cd9008ba1d))
* invalid string in strings list ([f08b53b](https://github.com/someone5678/revanced-patches/commit/f08b53b07d93bd8ac6e7da376ea6e6023e53076e))
* invalid version in compatibility annotation ([#90](https://github.com/someone5678/revanced-patches/issues/90)) ([df43547](https://github.com/someone5678/revanced-patches/commit/df435475cdd0494a1e4ea9e2980c2998c9bc7048))
* listing of wrong fingerprint class ([#147](https://github.com/someone5678/revanced-patches/issues/147)) ([95c2bbd](https://github.com/someone5678/revanced-patches/commit/95c2bbdd1deb1d76f1177b48286fa6a3bc9f7663))
* loop in `amoled` patch ([c4c86b6](https://github.com/someone5678/revanced-patches/commit/c4c86b65fd8b2463c1d86ad2e46ec9f08e60d47c))
* make `custom-branding` cross-platform ([#366](https://github.com/someone5678/revanced-patches/issues/366)) ([040c937](https://github.com/someone5678/revanced-patches/commit/040c93711701fde7d80e83403a34ffc7be5c2867))
* make `minimized-playback-manager-fingerprint` unique ([#120](https://github.com/someone5678/revanced-patches/issues/120)) ([cd5e911](https://github.com/someone5678/revanced-patches/commit/cd5e911f4ed9ad95b02c13c30cd9466d250e8904))
* make all patches toggleable with settings ([#202](https://github.com/someone5678/revanced-patches/issues/202)) ([7e1d82f](https://github.com/someone5678/revanced-patches/commit/7e1d82f1161237632c3a57f109db6b8903006b33))
* **metanav/fix-scaling:** use semantic versioning in package versions ([e327a0e](https://github.com/someone5678/revanced-patches/commit/e327a0eb2ff31e158f73e61bbc560c74a8b50d7d))
* migrate patches to latest patcher api changes ([8a0ee03](https://github.com/someone5678/revanced-patches/commit/8a0ee03a71cf4a000c9a7246d0e64ed8291a5127))
* migrate to `include` annotation ([110bbf1](https://github.com/someone5678/revanced-patches/commit/110bbf143a9cec8dce1f0416cff40f8d93055e96))
* migrate to breaking changes from patcher ([2c0a419](https://github.com/someone5678/revanced-patches/commit/2c0a4196fed2fbdcd454ed882b720898d3050c51))
* migrate to new `proxy` api ([db32ffe](https://github.com/someone5678/revanced-patches/commit/db32ffe56a8e73177bef724ee10eda9a28b367b8))
* migrate to new patcher api ([f43446e](https://github.com/someone5678/revanced-patches/commit/f43446ed189e583302fcd899f5eb7517f2a77144))
* missing brackets at inlining ([8936c8a](https://github.com/someone5678/revanced-patches/commit/8936c8aaedb56817cda5eec5f4a8c32f433862aa))
* missing extension method `doRecursively` ([e9c9460](https://github.com/someone5678/revanced-patches/commit/e9c946008ee912652d288e515b83b52ae2d239d8))
* modified opcode for `show-video-ads-constructor` ([a0dcea3](https://github.com/someone5678/revanced-patches/commit/a0dcea3a13f68cae449dfaf445b542e339c83ff0))
* multiple bugs in patches ([e37201d](https://github.com/someone5678/revanced-patches/commit/e37201d0ceef474696857a0d8845950c888194d0))
* multiple compatible pkgs on readme ([88c1450](https://github.com/someone5678/revanced-patches/commit/88c1450fa4e79994b59b38c9f1c68be1a1d1a2be))
* name for `IntegrationsPatch` ([e46ef02](https://github.com/someone5678/revanced-patches/commit/e46ef02302825d62b57912b2747a25f858036bb7))
* old usage of `toInstructions` extension method ([65ddd52](https://github.com/someone5678/revanced-patches/commit/65ddd522dca19e0590d9cb6fdb2d85ad7b98481e))
* package name for Vanced ([#390](https://github.com/someone5678/revanced-patches/issues/390)) ([e78749d](https://github.com/someone5678/revanced-patches/commit/e78749d4b6af4d0c3b29d4dd20595c21a777faa8))
* partial ad blockage in `tiktok-ads` patch ([#420](https://github.com/someone5678/revanced-patches/issues/420)) ([a3b549b](https://github.com/someone5678/revanced-patches/commit/a3b549b09e0e60a6875b4dd81edaa3bf0af0707d))
* patch description consistency ([#134](https://github.com/someone5678/revanced-patches/issues/134)) ([da5896d](https://github.com/someone5678/revanced-patches/commit/da5896dde0a2b2b9ffe65e486402e4ef92ec1ce9))
* patcher not propagating dexlib ([980c486](https://github.com/someone5678/revanced-patches/commit/980c48673259496d793bc7f864ad355188dcf7b6))
* path for download icon ([#465](https://github.com/someone5678/revanced-patches/issues/465)) ([56ad0f0](https://github.com/someone5678/revanced-patches/commit/56ad0f02e5bb4a707b08e84fbaab6cf4ebdda13b))
* **predictive-back-gesture:** create attribute, if it does not exist ([c00e771](https://github.com/someone5678/revanced-patches/commit/c00e7717053f806e3b5b3f0bf0ca9c2da07c289b))
* print instruction index of warning ([9e29aee](https://github.com/someone5678/revanced-patches/commit/9e29aeeeff222412f6c45cf7e4879f8ec53ca6ee))
* publish releases ([83916f9](https://github.com/someone5678/revanced-patches/commit/83916f96d27989dcbb35c0ba6ef326a16b470501))
* put back proper variable ([#61](https://github.com/someone5678/revanced-patches/issues/61)) ([d26c423](https://github.com/someone5678/revanced-patches/commit/d26c4233031fd418eb37c8f05e9bc1857e0572e6))
* Readd `swipe-controls` patch ([#123](https://github.com/someone5678/revanced-patches/issues/123)) ([7f2a2b2](https://github.com/someone5678/revanced-patches/commit/7f2a2b2ee4e6045d53aba4e7705431b643981107))
* references to integrations in `return-youtube-dislike` patch ([5824c2c](https://github.com/someone5678/revanced-patches/commit/5824c2cdfb1a2d7b8d68044388e5e0746ef2ca09))
* release `patches.json` file ([#402](https://github.com/someone5678/revanced-patches/issues/402)) ([e941c0a](https://github.com/someone5678/revanced-patches/commit/e941c0a3146e6da386177c71b96a81c56365e160))
* releases ([30d5c9a](https://github.com/someone5678/revanced-patches/commit/30d5c9a67ccf88ca6ac00d0a9f2a2e330f8092dd))
* remove `HideSuggestionsPatch` from `Index` ([f32e474](https://github.com/someone5678/revanced-patches/commit/f32e4747b512c675b807ff5eebfd0b8e66173fba))
* remove broken video-quality patch ([e8d516a](https://github.com/someone5678/revanced-patches/commit/e8d516af896971a09bb9aca8b00e7b7bb57c3dd9))
* remove refreshing home screen not working ([6c24ebe](https://github.com/someone5678/revanced-patches/commit/6c24ebef2fb4f0d58e369ac5bf63e4cab6ca0e80))
* remove requirement for solution [skip ci] ([#271](https://github.com/someone5678/revanced-patches/issues/271)) ([553fad3](https://github.com/someone5678/revanced-patches/commit/553fad3fe1bb79bdf34e9f91c0e1cbfda78e1054))
* remove unnecessary version constraints ([#117](https://github.com/someone5678/revanced-patches/issues/117)) ([1cddf8d](https://github.com/someone5678/revanced-patches/commit/1cddf8d9063da3bbdba0fd7080c8c93768b83a4c))
* remove unused patches ([d12e92a](https://github.com/someone5678/revanced-patches/commit/d12e92aead677fefa9dcb48748d783225b65fab1))
* rename `default-video-quality` to `remember-video-quality` ([7f6cdfd](https://github.com/someone5678/revanced-patches/commit/7f6cdfd7c2b5e72742bbb92e4d584f722cb82cae))
* rename autorepeat-by-default patch to always-autorepeat ([3606015](https://github.com/someone5678/revanced-patches/commit/3606015d715f150cc51fbb29adf3be252b96faab))
* resolve fingerprint in `premium-icon-reddit` patch ([#413](https://github.com/someone5678/revanced-patches/issues/413)) ([c228187](https://github.com/someone5678/revanced-patches/commit/c228187615c75d1be0670bb1f0b4ad661c2e0549))
* revert `swipe-controls` patch  ([66e1f33](https://github.com/someone5678/revanced-patches/commit/66e1f3384a58361737ba889d946be875b23f3163))
* rollback to `Dependencies` annotation ([36a2ae8](https://github.com/someone5678/revanced-patches/commit/36a2ae886c63f1d22bb1cca9e7110af6c3f6f2d3))
* run meta generator ([87405b8](https://github.com/someone5678/revanced-patches/commit/87405b875900281cd7836e21bef04ea93840370a))
* **seekbar-tapping:** do not disable seekbar when hiding it ([#600](https://github.com/someone5678/revanced-patches/issues/600)) ([a151deb](https://github.com/someone5678/revanced-patches/commit/a151deb6087ecde3bd67b296e0abf4b6520bc5d8))
* show minimized playback options in settings ([#118](https://github.com/someone5678/revanced-patches/issues/118)) ([6e1a538](https://github.com/someone5678/revanced-patches/commit/6e1a538d34291d75f19bf66a188bc69241de3a7a))
* signature checker with changes of patcher ([e82459d](https://github.com/someone5678/revanced-patches/commit/e82459d37759e1a5a860d3e7fcdf69d95b06858e))
* some more refactoring of integrations, add hide-watermark patch ([#63](https://github.com/someone5678/revanced-patches/issues/63)) ([feb09c5](https://github.com/someone5678/revanced-patches/commit/feb09c56f475e2537a67d3636b08737848158a8e))
* spelling mistake ([52f9147](https://github.com/someone5678/revanced-patches/commit/52f9147ee8d591f786397d174dc02a141d9250a9))
* **sponsorblock:** broken fingerprint and invert setting `shorts_playing` ([#579](https://github.com/someone5678/revanced-patches/issues/579)) ([383a473](https://github.com/someone5678/revanced-patches/commit/383a473bb75866413cab42f6fff2dfcd7e2c5bf8))
* **sponsorblock:** correct class name for field reference ([#582](https://github.com/someone5678/revanced-patches/issues/582)) ([355724a](https://github.com/someone5678/revanced-patches/commit/355724a09d749f4f30b798fb3a3a48bd36955221))
* **sponsorblock:** dynamically insert `setSponsorBarRect` call ([#644](https://github.com/someone5678/revanced-patches/issues/644)) ([12af4b1](https://github.com/someone5678/revanced-patches/commit/12af4b147878f04196e64a816025fcf9cf0c7148))
* **sponsorblock:** reflect changes to strings ([#585](https://github.com/someone5678/revanced-patches/issues/585)) ([0ce5e10](https://github.com/someone5678/revanced-patches/commit/0ce5e10e721dc3234cd9441285ee25229a4f86b9))
* **sponsorblock:** reflect strings from official guidelines ([#523](https://github.com/someone5678/revanced-patches/issues/523)) ([9b21851](https://github.com/someone5678/revanced-patches/commit/9b2185103b2761e25e8b41d452559452cc9efa7e))
* **sponsorblock:** resolve unresolved fingerprint ([d49c662](https://github.com/someone5678/revanced-patches/commit/d49c662a3338f087761d99290bf0d8b111ccb57c))
* spoof `X-Android-Cert` of Firebase `authToken` api request ([#315](https://github.com/someone5678/revanced-patches/issues/315)) ([c81d61f](https://github.com/someone5678/revanced-patches/commit/c81d61f685449590473fa5205e7709f81872a9b9))
* **spotify/disable-capture-restriction:** dynamically find indices ([#759](https://github.com/someone5678/revanced-patches/issues/759)) ([ee8cda5](https://github.com/someone5678/revanced-patches/commit/ee8cda5a4c88ba73aaeb43d5396b7a6e68211978))
* sync version ([6170e36](https://github.com/someone5678/revanced-patches/commit/6170e3689d9c8998be94a8464352af620cccd11b))
* syntax error in compatiblity annotation ([#1181](https://github.com/someone5678/revanced-patches/issues/1181)) ([9fdf7a4](https://github.com/someone5678/revanced-patches/commit/9fdf7a40f9fa3c451e32b0a581ac43d5cf739b45))
* **tasker/unlock-license:** resolve fingerprint correctly ([92d7857](https://github.com/someone5678/revanced-patches/commit/92d78576f033dd7155c80cb08d5911048b06c36c))
* tests failing ([102793f](https://github.com/someone5678/revanced-patches/commit/102793f24f8bf7c7fd254968b29d65da7b2b962f))
* **theme:** include coloring the playlist action bar ([#742](https://github.com/someone5678/revanced-patches/issues/742)) ([f983d33](https://github.com/someone5678/revanced-patches/commit/f983d335212801440f51bf45892d18db88af1b24))
* **tiktok/settings:** make compatible with newer versions ([c88740d](https://github.com/someone5678/revanced-patches/commit/c88740dc2bf040747d9704d5bed52a7b533c22d6))
* **tiktok/settings:** make compatible with newer versions ([#1057](https://github.com/someone5678/revanced-patches/issues/1057)) ([54cea3d](https://github.com/someone5678/revanced-patches/commit/54cea3d5d02b5e827a944f0625c9df7187d2d9a1))
* **tiktok/tiktok-downloads:** add missing patch dependencies ([#686](https://github.com/someone5678/revanced-patches/issues/686)) ([e5f66f6](https://github.com/someone5678/revanced-patches/commit/e5f66f6aca0fdda009449283a5eb6ed51d75ca90))
* trigger release on `build` commits ([be8bd1b](https://github.com/someone5678/revanced-patches/commit/be8bd1b2a4b91f9763448661a802a5dc4a6b1d1d))
* **twitter patches.:** use wider compatible Java API for writing to file ([#678](https://github.com/someone5678/revanced-patches/issues/678)) ([0d6c503](https://github.com/someone5678/revanced-patches/commit/0d6c503fb6000bdc0cd62c9944df9829d2b8273c))
* **twitter/monochrome-icon:** add missing `File.write` call ([#682](https://github.com/someone5678/revanced-patches/issues/682)) ([fa42fb3](https://github.com/someone5678/revanced-patches/commit/fa42fb3269da964133efc2424b773f93220d944a))
* update `HomeAdsPatch` ([62f1801](https://github.com/someone5678/revanced-patches/commit/62f1801e9cbee53c0be3413c245161bd941e4aec))
* update patcher version ([e3d0bb7](https://github.com/someone5678/revanced-patches/commit/e3d0bb7ee1923ea996cf637267c62d233a74c7fa))
* update patcher version ([5f54bc9](https://github.com/someone5678/revanced-patches/commit/5f54bc9aa8fd8b83448141a9b05746e3e977369d))
* update patcher version ([#35](https://github.com/someone5678/revanced-patches/issues/35)) ([1a379df](https://github.com/someone5678/revanced-patches/commit/1a379dfd974b9f92d4bd0d5d7a4711eb6d1060b3)), closes [#34](https://github.com/someone5678/revanced-patches/issues/34)
* update patches ([91b8ec8](https://github.com/someone5678/revanced-patches/commit/91b8ec81f33417798546c32db708fe09ada3930c))
* update patches to `17.26.35` ([#142](https://github.com/someone5678/revanced-patches/issues/142)) ([b04112c](https://github.com/someone5678/revanced-patches/commit/b04112c8562a7b95e7555e894b665913094b33eb))
* use dependency in correct patch ([a2a1ee8](https://github.com/someone5678/revanced-patches/commit/a2a1ee8eb5e059b30fe58c918a80976ef4d7b637))
* use original app name ([#977](https://github.com/someone5678/revanced-patches/issues/977)) ([39148c8](https://github.com/someone5678/revanced-patches/commit/39148c82a036f4bf0524d3379dc9213ebb855b44))
* use the latest version of patcher dependency ([fe4a439](https://github.com/someone5678/revanced-patches/commit/fe4a439cb2bc5e385ae13e8e155f25bb15e74633))
* version in package metadata of music ([b299205](https://github.com/someone5678/revanced-patches/commit/b299205aa7cde82f1f55fc598de3ff8d80b8bcb0))
* **video-ads:** block remaining video ads ([5147404](https://github.com/someone5678/revanced-patches/commit/5147404c9ee8c439b5417e5a48c6fb445c8c67c2))
* **video-ads:** clobber unused register ([403c858](https://github.com/someone5678/revanced-patches/commit/403c8583b0744c12ff4b9d73910db2831785c53f))
* **video-ads:** invert the condition to hide ads ([d9dcedd](https://github.com/someone5678/revanced-patches/commit/d9dcedd9f467bb8eca7c7494e08c6b924a58208d))
* **video-ads:** return empty ad list instead of null ([b86be41](https://github.com/someone5678/revanced-patches/commit/b86be41784abd472cb1acb7340a4b1b03789bfed))
* **video-ads:** return empty list in correct method ([1159406](https://github.com/someone5678/revanced-patches/commit/1159406c05e51b2a54d7fbf42ceee0fa1001e8a7))
* **VideoAds:** remove `istore1` opcode ([dc4ec57](https://github.com/someone5678/revanced-patches/commit/dc4ec574414c5df959efa0ca8f1cd39a812fedf8))
* wording [skip ci] ([ba64d9e](https://github.com/someone5678/revanced-patches/commit/ba64d9efc3ee606e9bda30ad7f8017af34b1dc3f))
* wrap theme option ([62c90f9](https://github.com/someone5678/revanced-patches/commit/62c90f916b5d27e5b11e44eb5fcb9e67a0d0ed22))
* write while reading resources and remove checking for "." in resource extensions ([7bc6094](https://github.com/someone5678/revanced-patches/commit/7bc60943cb2350e89dac091ec9c98c5effd0b8a9))
* wrong access flag in signature for `Create button patch` ([9fbb89d](https://github.com/someone5678/revanced-patches/commit/9fbb89d05336a256a0759eea6095e073946c45e5))
* wrong annotation and signature in patches ([a0fdee8](https://github.com/someone5678/revanced-patches/commit/a0fdee81a6d6773603520e7c3040ae8637642d58))
* wrong dependency version ([3a6348e](https://github.com/someone5678/revanced-patches/commit/3a6348e1fc1bd3838f8a5d9672a4960ef2a1393b))
* wrong dex path ([170fbbb](https://github.com/someone5678/revanced-patches/commit/170fbbb99e4a2dbe3e0febe44d07a692aa9d7224))
* wrong opcode for `create-button-method` ([3214650](https://github.com/someone5678/revanced-patches/commit/32146506f139aebc44cd5faffb7706b8b9c21c3d))
* wrong opcode pattern for `create-button-method` ([f4d8a85](https://github.com/someone5678/revanced-patches/commit/f4d8a8525bc64b90748b21979d463977a21dcd85))
* wrong opcode pattern for `enable-seekbar-tapping-signature` ([1d83395](https://github.com/someone5678/revanced-patches/commit/1d833957ed3e01188770c85e3d84e483419bd797))
* wrong opcode pattern for signature in `Hide suggestions patch` ([535aee0](https://github.com/someone5678/revanced-patches/commit/535aee08408b990c80f5966c13fa84666a8b35d0))
* wrong patches in `upgrade-tab-remover` ([5182290](https://github.com/someone5678/revanced-patches/commit/518229031ceca049ad790f7b77b19405d39f0ce1))
* wrong signature for `hide-reels-signature` ([2d9ff2a](https://github.com/someone5678/revanced-patches/commit/2d9ff2af0a991d7721f3741187716a3b08bb4029))
* wrong signatures for patch `Old Quality Layout Patch` ([823e503](https://github.com/someone5678/revanced-patches/commit/823e503d84037bdf27b09f17e63383f963c76854))
* wrong versions of patches ([a112b22](https://github.com/someone5678/revanced-patches/commit/a112b22ce6e685204caab6f95f511e26ef95806b))
* **youtube/bottom-controls-resource-patch:** use correct length for `nameSpaceLength` ([#1401](https://github.com/someone5678/revanced-patches/issues/1401)) ([7190066](https://github.com/someone5678/revanced-patches/commit/7190066a8ded8b59970483a81d7902526d552093))
* **youtube/custom-branding:** use high resolution icons ([#1018](https://github.com/someone5678/revanced-patches/issues/1018)) ([c8f2e8e](https://github.com/someone5678/revanced-patches/commit/c8f2e8ed9c256a45bc389449ac6467ea2ac50090))
* **youtube/custom-branding:** use proper scaled icons ([d874cc6](https://github.com/someone5678/revanced-patches/commit/d874cc61828501106e8a4711c90fc06ccb12f75c))
* **youtube/custom-video-speed:** fuzzy scan on fingerprint  ([#1135](https://github.com/someone5678/revanced-patches/issues/1135)) ([de1382f](https://github.com/someone5678/revanced-patches/commit/de1382fd9904159a97b2fac7c6475c51ae6cb706))
* **youtube/disable-startup-shorts-player:** do not prevent playing videos on startup ([#714](https://github.com/someone5678/revanced-patches/issues/714)) ([5b904dc](https://github.com/someone5678/revanced-patches/commit/5b904dc5d3aba5d748e977350909b7c6a4c43c91))
* **youtube/disable-startup-shorts-player:** don't affect functionality of navigation bar  ([#716](https://github.com/someone5678/revanced-patches/issues/716)) ([e938ba9](https://github.com/someone5678/revanced-patches/commit/e938ba99b55402f3336cdd18bd8d07780d5173a2))
* **youtube/general-ads:** don't early return when not necessary ([#1353](https://github.com/someone5678/revanced-patches/issues/1353)) ([003a400](https://github.com/someone5678/revanced-patches/commit/003a400ce41ff543fb5484c576f5ec2df0a87273))
* **youtube/general-ads:** hide ads on wide screens ([#765](https://github.com/someone5678/revanced-patches/issues/765)) ([2247958](https://github.com/someone5678/revanced-patches/commit/22479585bbf65a64cbc0a5d1b9cd53acd72915bd))
* **youtube/general-ads:** hide ads with buttons ([07c78a9](https://github.com/someone5678/revanced-patches/commit/07c78a91288cc8a8690bcdf9dbac895b76445630))
* **youtube/general-ads:** hide bytecode home ad view ([a438a47](https://github.com/someone5678/revanced-patches/commit/a438a47927fa8d273040f3bdff7d145c1d7ffaaa))
* **youtube/general-ads:** hide reels shelf ([3f994ff](https://github.com/someone5678/revanced-patches/commit/3f994ff18edc1a5218983504db467b6b6beeb474))
* **youtube/general-ads:** import correct compatibility annotation ([#1065](https://github.com/someone5678/revanced-patches/issues/1065)) ([0d602d2](https://github.com/someone5678/revanced-patches/commit/0d602d2a8353654715c8dbe47a385b2ee7aaba8e))
* **youtube/general-ads:** incorrect description for info panels ([fb18e9c](https://github.com/someone5678/revanced-patches/commit/fb18e9c2edf6e9147b309fd38ccd3cad077fa859))
* **youtube/general-ads:** remove unused switch ([6753d78](https://github.com/someone5678/revanced-patches/commit/6753d7856732a7b94e5b1530df78fa3e48c9ee08))
* **youtube/general-ads:** resolve fingerprint to correct method ([#1404](https://github.com/someone5678/revanced-patches/issues/1404)) ([e135485](https://github.com/someone5678/revanced-patches/commit/e1354852501cb582549cbf0634b1a15e1d0012d9))
* **youtube/general-ads:** restore swipe back to exit gesture ([#1405](https://github.com/someone5678/revanced-patches/issues/1405)) ([2440587](https://github.com/someone5678/revanced-patches/commit/24405877dd935a757fa61c7580887c1a47a25ea9))
* **youtube/hide-endscreen-cards:** restore functionality ([#993](https://github.com/someone5678/revanced-patches/issues/993)) ([9de797b](https://github.com/someone5678/revanced-patches/commit/9de797bf05de970caacad9172bf543c9bd1e2797))
* **youtube/hide-info-cards:** remove initial popup of info-cards ([#992](https://github.com/someone5678/revanced-patches/issues/992)) ([d4771f7](https://github.com/someone5678/revanced-patches/commit/d4771f7c9aa6fd312192524f50c041dffe25f1a7))
* **youtube/hide-mix-playlists:** correct switch title, summary and defaults ([#821](https://github.com/someone5678/revanced-patches/issues/821)) ([965572a](https://github.com/someone5678/revanced-patches/commit/965572a28b9d6cee899f68bf79b9afd71dd69bbd))
* **youtube/integrations:** set context for remaining activities ([#828](https://github.com/someone5678/revanced-patches/issues/828)) ([ba9cbaf](https://github.com/someone5678/revanced-patches/commit/ba9cbaf127c4b24890535997ce28882458e03e78))
* **youtube/litho-filter:** use correct type for switch case ([#1068](https://github.com/someone5678/revanced-patches/issues/1068)) ([e46fa2c](https://github.com/someone5678/revanced-patches/commit/e46fa2c6a7be343e56812ff99c616db203f2de7e))
* **youtube/theme-patch:** respect app specific theme ([#946](https://github.com/someone5678/revanced-patches/issues/946)) ([98964e8](https://github.com/someone5678/revanced-patches/commit/98964e8e4973ff5d0361cc509febed397ff657c7))
* **youtube/theme:** add missing theme condition check ([#771](https://github.com/someone5678/revanced-patches/issues/771)) ([c8803b9](https://github.com/someone5678/revanced-patches/commit/c8803b9951e1f9a8b2b32187da958c463a8db0fd))
* **youtube/theme:** colore the comment action bar ([#762](https://github.com/someone5678/revanced-patches/issues/762)) ([fdea41b](https://github.com/someone5678/revanced-patches/commit/fdea41ba94fafc2a327d7f1f7efddacc195ac8d4))
* **youtube/theme:** extend dark mode theming ([#827](https://github.com/someone5678/revanced-patches/issues/827)) ([0d4028f](https://github.com/someone5678/revanced-patches/commit/0d4028fa8f0e96fbd02c6b08396a1fbd2b8472fa))
* **youtube/theme:** theme litho ui components & use correct theme for settings ([#791](https://github.com/someone5678/revanced-patches/issues/791)) ([ea1f86d](https://github.com/someone5678/revanced-patches/commit/ea1f86d3125bff0186b8411fbd55e35c08d35a1a))
* **youtube/theme:** theme missing gray color ([#873](https://github.com/someone5678/revanced-patches/issues/873)) ([0e04efb](https://github.com/someone5678/revanced-patches/commit/0e04efb77484a3389c7a08d075473b9530ff48d8))
* **youtube/video-ads:** add back initial method to block ads ([#818](https://github.com/someone5678/revanced-patches/issues/818)) ([8943905](https://github.com/someone5678/revanced-patches/commit/89439053736feab8b8ebda8657076cb106c86894))
* **youtube/video-ads:** add switch to temporarily fix buffering issues ([6461877](https://github.com/someone5678/revanced-patches/commit/64618772b271c3f6607f0aec88c6a9781da3978f))
* **youtube/video-ads:** block earlier in call hirarchy ([#813](https://github.com/someone5678/revanced-patches/issues/813)) ([d5b39b3](https://github.com/someone5678/revanced-patches/commit/d5b39b3adc5bd7a3503ab28202e1576ab47bc30c))
* **youtube/video-ads:** invert condition to hide ads ([49b4ca9](https://github.com/someone5678/revanced-patches/commit/49b4ca9fd205b84927832ecdbead911b7776ddcf))
* **youtube/video-ads:** return empty ad list earlier ([e346f7f](https://github.com/someone5678/revanced-patches/commit/e346f7f0706ec0f686bb5d3222ef018a6e9ad1c9))
* **youtube/video-ads:** revert faulty method patch ([#820](https://github.com/someone5678/revanced-patches/issues/820)) ([ddfc18a](https://github.com/someone5678/revanced-patches/commit/ddfc18a811a5df6573f90595717b45441dff06ec))
* **youtube/video-information:** use correct compatibility annotation ([506b134](https://github.com/someone5678/revanced-patches/commit/506b1345ab986b641ebb227b3da3a921e9748bde))
* **youtube:** resolve fingerprints on mutable methods ([e40857f](https://github.com/someone5678/revanced-patches/commit/e40857fe8a34175fe592209dcbeda1822b2a90aa))
* **youtube:** swipe gesture on home screen ([cfe765e](https://github.com/someone5678/revanced-patches/commit/cfe765e991a206ebb9d10c402e4fda48aa4df7fc)), closes [#610](https://github.com/someone5678/revanced-patches/issues/610)


### Code Refactoring

* migrate from `Signature` to `Fingerprint` ([084078e](https://github.com/someone5678/revanced-patches/commit/084078e7f1852ccd2045e3fa8aedc25a7fd5faa8))
* Rename `net.revanced` to `app.revanced` ([68ea89f](https://github.com/someone5678/revanced-patches/commit/68ea89f15e9ea077df0d0ac20a40b735bb5ae26c))


### Features

* `autorepeat-by-default` patch ([#106](https://github.com/someone5678/revanced-patches/issues/106)) ([e0ac9f3](https://github.com/someone5678/revanced-patches/commit/e0ac9f385fc360f4dd2451e26676633120356c10))
* `client-spoof` patch ([e40bff5](https://github.com/someone5678/revanced-patches/commit/e40bff50c2a83380a2aab9e14cfcea5249a8d3d3))
* `comment` patch ([#858](https://github.com/someone5678/revanced-patches/issues/858)) ([f0f6c52](https://github.com/someone5678/revanced-patches/commit/f0f6c52828befe50500b7a26f0575986c7252256))
* `compact-header` patch ([83753ba](https://github.com/someone5678/revanced-patches/commit/83753bacf8f56ad16f8abafc02034f1595c12532))
* `custom-branding` patch ([0d65ea8](https://github.com/someone5678/revanced-patches/commit/0d65ea8cdb0e02287f6be6855cd3d28823a61e70))
* `custom-playback-speed` patch ([#50](https://github.com/someone5678/revanced-patches/issues/50)) ([224254b](https://github.com/someone5678/revanced-patches/commit/224254bcce2b394bbfd2549089f0204ce4ed4a89))
* `default-video-quality` patch ([#141](https://github.com/someone5678/revanced-patches/issues/141)) ([609ad7d](https://github.com/someone5678/revanced-patches/commit/609ad7dee7e29b2ecc4e95a93e9dab1646b4b050))
* `Dependencies` annotation ([85806bb](https://github.com/someone5678/revanced-patches/commit/85806bb355e342ecb33d4ee1e76f9edf89b2c2ee))
* `disable-auto-captions` patch ([#435](https://github.com/someone5678/revanced-patches/issues/435)) ([ae77709](https://github.com/someone5678/revanced-patches/commit/ae77709ea7c8c064df84d256cba14704439121e3))
* `disable-auto-player-popup-panels` ([#543](https://github.com/someone5678/revanced-patches/issues/543)) ([69c9b58](https://github.com/someone5678/revanced-patches/commit/69c9b58cb8f4f49f43a2ea2ed140b45a04104b06))
* `disable-autoplay-button` patch ([#79](https://github.com/someone5678/revanced-patches/issues/79)) ([0d6fb51](https://github.com/someone5678/revanced-patches/commit/0d6fb51e025649aae37e230778ea367482fab0d7))
* `disable-capture-restriction` patch ([#655](https://github.com/someone5678/revanced-patches/issues/655)) ([1109424](https://github.com/someone5678/revanced-patches/commit/11094248f0bb54089ab6569d09a95c82bfa88fc1))
* `disable-fullscreen-panels` patch ([3bf0561](https://github.com/someone5678/revanced-patches/commit/3bf056163500b006d1a20c5f3a3e0c92fec13bd8))
* `disable-startup-shorts-player` patch ([#670](https://github.com/someone5678/revanced-patches/issues/670)) ([daea026](https://github.com/someone5678/revanced-patches/commit/daea026a2c0b4282c45a580e32ae30c27c2c1c36))
* `downloads` patch ([#215](https://github.com/someone5678/revanced-patches/issues/215)) ([b82114b](https://github.com/someone5678/revanced-patches/commit/b82114bddf942d002e49e64057bd0c556b7567ce))
* `dynamic-color` patch ([#652](https://github.com/someone5678/revanced-patches/issues/652)) ([a23ba9a](https://github.com/someone5678/revanced-patches/commit/a23ba9aefa678e5465a3dd95c849e2202d3007dc))
* `enable-debugging` patch ([#116](https://github.com/someone5678/revanced-patches/issues/116)) ([bb355e7](https://github.com/someone5678/revanced-patches/commit/bb355e7b7e78e602a10b346fe7e5795463615a81))
* `fix-metanav-scaling` patch ([#831](https://github.com/someone5678/revanced-patches/issues/831)) ([24e0146](https://github.com/someone5678/revanced-patches/commit/24e0146964efb03c35ad9b7f7de1927724140f3f))
* `force-vp9-codec` patch ([#157](https://github.com/someone5678/revanced-patches/issues/157)) ([07806a1](https://github.com/someone5678/revanced-patches/commit/07806a16e5368118949e0e476e901987433ad403))
* `general-reddit-ads` patch ([#235](https://github.com/someone5678/revanced-patches/issues/235)) ([d63c016](https://github.com/someone5678/revanced-patches/commit/d63c016d38d2a5b1d152abccdb582990987a1911))
* `GeneralBytecodeAds` and `GeneralResourceAds` patch ([f99bbef](https://github.com/someone5678/revanced-patches/commit/f99bbef4c911ac2492166c7a3792ea11ffceffab))
* `hdr-max-brightness` patch ([#105](https://github.com/someone5678/revanced-patches/issues/105)) ([1310573](https://github.com/someone5678/revanced-patches/commit/131057366a777786d6016d3385584b4e17bc4a8b))
* `hide-album-cards` patch ([#857](https://github.com/someone5678/revanced-patches/issues/857)) ([618de17](https://github.com/someone5678/revanced-patches/commit/618de17a40d2349ca3197097799f78ee7287d976))
* `hide-artist-card` patch ([#859](https://github.com/someone5678/revanced-patches/issues/859)) ([eade139](https://github.com/someone5678/revanced-patches/commit/eade139811bd3bc90a289b2c81b4b32cfa2dee42))
* `hide-cast-button` patch ([2cd531e](https://github.com/someone5678/revanced-patches/commit/2cd531eb5a334f3cf91cba4556f07e863cd9ec1b))
* `hide-crowdfunding-box` patch ([#856](https://github.com/someone5678/revanced-patches/issues/856)) ([e35bdf0](https://github.com/someone5678/revanced-patches/commit/e35bdf0193d4a6328e58fa36f1301c87a143ff72))
* `hide-email-address` patch ([#578](https://github.com/someone5678/revanced-patches/issues/578)) ([346b9bd](https://github.com/someone5678/revanced-patches/commit/346b9bdaae6da72adc5b0f2330ef4fd0a10e9551))
* `hide-get-premium` patch ([#195](https://github.com/someone5678/revanced-patches/issues/195)) ([639aab4](https://github.com/someone5678/revanced-patches/commit/639aab411ee514b50840c15c8e9a1a889854403f))
* `hide-infocard-suggestions` patch ([#107](https://github.com/someone5678/revanced-patches/issues/107)) ([31a767a](https://github.com/someone5678/revanced-patches/commit/31a767adbb152906303ab0ae5250769fc38d0625))
* `hide-premium-nav-bar` patch ([#589](https://github.com/someone5678/revanced-patches/issues/589)) ([cb78f8e](https://github.com/someone5678/revanced-patches/commit/cb78f8e6d025759773a01ffd4e4fba04ffd105b0))
* `hide-shorts-button` patch ([88352ee](https://github.com/someone5678/revanced-patches/commit/88352ee6ecd23faa4a7fd9f7495e67fa1d3e33bd))
* `hide-time-and-seekbar` patch ([#544](https://github.com/someone5678/revanced-patches/issues/544)) ([9575f63](https://github.com/someone5678/revanced-patches/commit/9575f633e92cf540f344f4add8a1447564690fc6))
* `hide-video-buttons` patch ([81dd596](https://github.com/someone5678/revanced-patches/commit/81dd5961a46f4c60c052e990344a6a5586986de3))
* `hide-watch-in-vr` patch ([#911](https://github.com/someone5678/revanced-patches/issues/911)) ([f45ce59](https://github.com/someone5678/revanced-patches/commit/f45ce5938bf07fd6873c7f51c3fff9572d61a76e))
* `microg-patch` ([48bbd57](https://github.com/someone5678/revanced-patches/commit/48bbd574a52c8bf6834b26facfe7384b830f944a))
* `minimize-playback-music` patch ([#200](https://github.com/someone5678/revanced-patches/issues/200)) ([d4fd18b](https://github.com/someone5678/revanced-patches/commit/d4fd18bc74c92e17cdfb21b627b2f6a8919ff2dc))
* `monochrome-icon` patch ([#643](https://github.com/someone5678/revanced-patches/issues/643)) ([c282c3a](https://github.com/someone5678/revanced-patches/commit/c282c3a82ffe7d6922f3e9e6f98604e508173912))
* `music-microg-support` patch ([#208](https://github.com/someone5678/revanced-patches/issues/208)) ([50863e9](https://github.com/someone5678/revanced-patches/commit/50863e97cc8eba7e1ad6d11b4821baa45fdd29c4))
* `music-video-ads` patch ([#172](https://github.com/someone5678/revanced-patches/issues/172)) ([cbb71b5](https://github.com/someone5678/revanced-patches/commit/cbb71b5faf1386ed31dd9e0387f6cf0509d92d31))
* `predictive-back-gesture` patch ([#1236](https://github.com/someone5678/revanced-patches/issues/1236)) ([11b59f7](https://github.com/someone5678/revanced-patches/commit/11b59f767c94514d49a84593618ff9d2aace2636))
* `premium-heading` patch ([78913bf](https://github.com/someone5678/revanced-patches/commit/78913bf1e80f5b91d0dee506fdfe3f875e8e6988))
* `premium-icon-reddit` patch ([#333](https://github.com/someone5678/revanced-patches/issues/333)) ([fd09a3c](https://github.com/someone5678/revanced-patches/commit/fd09a3cfa9721f237b0a4650d3c08a130b35bb80))
* `promo-code-unlock` patch ([#292](https://github.com/someone5678/revanced-patches/issues/292)) ([d5df2e6](https://github.com/someone5678/revanced-patches/commit/d5df2e68f47cbb3d374b8ce24769872959014051))
* `ResourceUtils` helper class ([e0e1144](https://github.com/someone5678/revanced-patches/commit/e0e11447a7ac184d43c75955854c52c6992ff667))
* `return-youtube-dislikes` patch ([#175](https://github.com/someone5678/revanced-patches/issues/175)) ([18a66d8](https://github.com/someone5678/revanced-patches/commit/18a66d8454cf6e7cfdd4183631a6870c80d16b90))
* `settings` patch ([0e229a4](https://github.com/someone5678/revanced-patches/commit/0e229a46cb5b8b74183c47a6eae08d667f941406))
* `settings` patch framework ([#266](https://github.com/someone5678/revanced-patches/issues/266)) ([8af8cdb](https://github.com/someone5678/revanced-patches/commit/8af8cdbfd6c46229c9f08016e1c7d8f75b7535eb))
* `sponsorblock` patch ([#101](https://github.com/someone5678/revanced-patches/issues/101)) ([36af4cc](https://github.com/someone5678/revanced-patches/commit/36af4cc14ff8057c10b99019cb23acc6e5aec3f2)), closes [#89](https://github.com/someone5678/revanced-patches/issues/89) [#90](https://github.com/someone5678/revanced-patches/issues/90)
* `spotify-theme` patch ([#608](https://github.com/someone5678/revanced-patches/issues/608)) ([726de15](https://github.com/someone5678/revanced-patches/commit/726de151d5e6749dc2f7e2d59d5828c58e495818))
* `swipe-controls` override volume button behaviour ([#285](https://github.com/someone5678/revanced-patches/issues/285)) ([69465f3](https://github.com/someone5678/revanced-patches/commit/69465f3a9934973a2449605a248a462510e10ff6))
* `swipe-controls` patch ([#115](https://github.com/someone5678/revanced-patches/issues/115)) ([1d0a7dc](https://github.com/someone5678/revanced-patches/commit/1d0a7dcc0cc3ea2bcd8ce0221d5e2f53d6eb0ae5))
* `swipe-controls` rewrite ([#131](https://github.com/someone5678/revanced-patches/issues/131)) ([b7dba09](https://github.com/someone5678/revanced-patches/commit/b7dba09927ba15a9eacb06dcb4bf1f268560c96e))
* `tablet-mini-player` patch ([dae41f1](https://github.com/someone5678/revanced-patches/commit/dae41f1c59d26d00b1ba821dbe1521e68226f47c))
* `tastebuilder-remover` for music ([a6aeca3](https://github.com/someone5678/revanced-patches/commit/a6aeca31bd80b8c4a8acd071e22faca6e136bdb0))
* `tiktok-ads` patch ([#335](https://github.com/someone5678/revanced-patches/issues/335)) ([81bef57](https://github.com/someone5678/revanced-patches/commit/81bef57742bfaefcdfe02fd290cca6923341149a))
* `tiktok-download` and `tiktok-seekbar` patch ([#405](https://github.com/someone5678/revanced-patches/issues/405)) ([46949f0](https://github.com/someone5678/revanced-patches/commit/46949f0907cc27c798c5028cc9542b522ea0ba22))
* `tiktok-feed-filter` , `tiktok-settings` and `tiktok-force-login` patch ([#501](https://github.com/someone5678/revanced-patches/issues/501)) ([6279557](https://github.com/someone5678/revanced-patches/commit/627955742f3d00b5cc79c7e473f497f1c8c3fb38))
* `tiktok-speed` patch ([#668](https://github.com/someone5678/revanced-patches/issues/668)) ([9746b50](https://github.com/someone5678/revanced-patches/commit/9746b50055abaf1e6d06d53f28e95a4d376c923f))
* ˋpflotsh-ecmwf-subscription-unlockˋ patch ([#332](https://github.com/someone5678/revanced-patches/issues/332)) ([4c8578b](https://github.com/someone5678/revanced-patches/commit/4c8578b7b3b4de48ed175a8c0d9106ce1d646f59))
* add "Application Icon Path" option to branding ([1748d1e](https://github.com/someone5678/revanced-patches/commit/1748d1e5badf61213d793ff7ae1d090ea2ea82f0))
* add "Application Name" option to branding and move renaming to CustomBrandingPatch.kt ([8dafe05](https://github.com/someone5678/revanced-patches/commit/8dafe05b2c5e2b0291d46b02717d910721673712))
* Add (WIP) Signature Checker ([ae4c7b2](https://github.com/someone5678/revanced-patches/commit/ae4c7b29f211c461de460f97f3a8656e795adafb))
* add `amoled` patch ([d61bac4](https://github.com/someone5678/revanced-patches/commit/d61bac4f8243d0ef72ca91c7c1d5facd858d515e))
* add `custom-video-buffer` patch ([9f117c7](https://github.com/someone5678/revanced-patches/commit/9f117c74cdbdcf98eae97cf4c37f0baca451d695))
* add compatibility for YouTube v17.23.36 and v17.24.34 ([1812bc3](https://github.com/someone5678/revanced-patches/commit/1812bc39e0e88f1ab02ae8127e9000780eedf49c))
* add debug switch ([#391](https://github.com/someone5678/revanced-patches/issues/391)) ([3cd1c90](https://github.com/someone5678/revanced-patches/commit/3cd1c90a293e050294a1aed0cf0430d7c1f8b705))
* add deprecated & options to patches.json ([4b917b2](https://github.com/someone5678/revanced-patches/commit/4b917b21b7121c2fedbe24dbfac5704e2d104f7e))
* add home ads patch ([36cddd1](https://github.com/someone5678/revanced-patches/commit/36cddd1488683e19e2b927e34c80a4f0f3cace35))
* Add JSON meta ([cf871ff](https://github.com/someone5678/revanced-patches/commit/cf871ffad978e74761cd8b7ea7603651b8549375))
* add patches compatibility to the newest version ([799401d](https://github.com/someone5678/revanced-patches/commit/799401ddf99da0aaa5f52c39d3d3d4061370fd75))
* add publishing to package registry ([b475e09](https://github.com/someone5678/revanced-patches/commit/b475e09577db4dda7bbb45dbf170d78772834a6d))
* add semantic-release ([d60f1d0](https://github.com/someone5678/revanced-patches/commit/d60f1d06798d312b158b71691ecc87e828dccbc1))
* add youtube version 17.24.35 ([ec626cc](https://github.com/someone5678/revanced-patches/commit/ec626ccfa2bcf14b722d08110382de009a1c12b4))
* add youtube version 17.24.35 ([adc60a6](https://github.com/someone5678/revanced-patches/commit/adc60a6fa09f6a21800ba51b8ca888d11a17e870))
* add youtube version 17.25.34 ([#85](https://github.com/someone5678/revanced-patches/issues/85)) ([889c9d5](https://github.com/someone5678/revanced-patches/commit/889c9d564d16c6e68a52095a4fc8e6d04346c9e9))
* added `codecs-unlock` patch ([e5fd7ce](https://github.com/someone5678/revanced-patches/commit/e5fd7cece94b1ff5342178f59b29576db806e0f6))
* **amoled:** remove in favour of `theme` patch ([29b8f9e](https://github.com/someone5678/revanced-patches/commit/29b8f9ee5330617bd90664b7bed83c2493e104d3))
* **anytracker:** `unlock-premium` patch ([#1076](https://github.com/someone5678/revanced-patches/issues/1076)) ([77190fc](https://github.com/someone5678/revanced-patches/commit/77190fcb7000c3a693b097b5f30d2f15427c371e))
* **anytracker:** `unlock-premium` patch ([#1165](https://github.com/someone5678/revanced-patches/issues/1165)) ([635b2f6](https://github.com/someone5678/revanced-patches/commit/635b2f6593d5f984fbe11e4a05132eef9dc6832a))
* **anytracker:** remove `unlock-premium` patch ([#1094](https://github.com/someone5678/revanced-patches/issues/1094)) ([abe3914](https://github.com/someone5678/revanced-patches/commit/abe3914cd34b1a6a19f85c4e5c95659ac3eb778c))
* **backdrops:** `pro-unlock` patch ([#1121](https://github.com/someone5678/revanced-patches/issues/1121)) ([5230946](https://github.com/someone5678/revanced-patches/commit/52309463e4c02679f24eadd303e09f6ae3b7cb78))
* begin `MicroG Patch` ([91474ba](https://github.com/someone5678/revanced-patches/commit/91474ba07376c13e7a71685dfd8b6e6913ed5ee9))
* blacklist `.vsc` folder in `.gitignore` ([#331](https://github.com/someone5678/revanced-patches/issues/331)) ([7cd1ed8](https://github.com/someone5678/revanced-patches/commit/7cd1ed8eefc2832020e5a3e642841a0de9620629))
* bump compatibility of patches for Youtube to v17.23.35 ([3748d05](https://github.com/someone5678/revanced-patches/commit/3748d0533e62a8871ab2202ce9b61170a90dae62))
* bump compatibility of YouTube Music patches to v5.16.51 ([#238](https://github.com/someone5678/revanced-patches/issues/238)) ([4fa2a12](https://github.com/someone5678/revanced-patches/commit/4fa2a127d715f953a1e4efacaecbc218209a01f3))
* bump music patches to 5.17.51 ([#307](https://github.com/someone5678/revanced-patches/issues/307)) ([c303589](https://github.com/someone5678/revanced-patches/commit/c303589bd8d1956ce2e3c4c285d45a648b5db30f))
* bump patches compatibility to v17.36.37 ([b63707e](https://github.com/someone5678/revanced-patches/commit/b63707e52f96b97664d27918a8bd19e61cf17cfe))
* bump YouTube Music patches compatibility ([#809](https://github.com/someone5678/revanced-patches/issues/809)) ([5251286](https://github.com/someone5678/revanced-patches/commit/525128614acb21b7dc25618d7b2a7f07eacb65cf))
* bump YouTube Music patches compatibility to v5.26.52 ([#681](https://github.com/someone5678/revanced-patches/issues/681)) ([b696b3e](https://github.com/someone5678/revanced-patches/commit/b696b3e9d67125b060b5cadd22e077b7884d304f))
* bump YouTube Music patches to v5.21.52 ([#404](https://github.com/someone5678/revanced-patches/issues/404)) ([24a8178](https://github.com/someone5678/revanced-patches/commit/24a8178592f87be215d07f3f7593af662b37d9e6))
* bump YouTube Music patches to v5.22.54 ([#409](https://github.com/someone5678/revanced-patches/issues/409)) ([82335dc](https://github.com/someone5678/revanced-patches/commit/82335dc0beb422512084ed0f80511ae3316bfed0))
* bump YouTube Music patches to v5.23.50 ([#462](https://github.com/someone5678/revanced-patches/issues/462)) ([2645336](https://github.com/someone5678/revanced-patches/commit/26453368c96eb20e5b917072a6a78b5602e62211))
* bump YouTube Music patches to v5.25.51 ([#669](https://github.com/someone5678/revanced-patches/issues/669)) ([4804d7e](https://github.com/someone5678/revanced-patches/commit/4804d7ec29cc997d6c430a5de5f16480c42719dd))
* bump YouTube patches to `v17.32.35` ([#347](https://github.com/someone5678/revanced-patches/issues/347)) ([bf19565](https://github.com/someone5678/revanced-patches/commit/bf19565900271747b55dd3f5e46ad73653728932))
* bump YouTube patches to v17.41.37 ([#878](https://github.com/someone5678/revanced-patches/issues/878)) ([7ef568b](https://github.com/someone5678/revanced-patches/commit/7ef568bc87ad5b17edb1a3caf56b326dc9868277))
* bump youtube version to v17.33.42 ([#398](https://github.com/someone5678/revanced-patches/issues/398)) ([250e00c](https://github.com/someone5678/revanced-patches/commit/250e00c087793ab67ee7dd66113c6c116f3f89bf))
* bundle `dex` file into `jar` file ([#359](https://github.com/someone5678/revanced-patches/issues/359)) ([1d08491](https://github.com/someone5678/revanced-patches/commit/1d084917aeeddedca06eca327d4c0bf07b21c38f))
* **citra:** `premium-unlock` patch ([#1115](https://github.com/someone5678/revanced-patches/issues/1115)) ([4b49e24](https://github.com/someone5678/revanced-patches/commit/4b49e24ea7251ee7b722ed6a3545b31e4cd79cc1))
* **citra:** add compatibility for canary package ([#1256](https://github.com/someone5678/revanced-patches/issues/1256)) ([42ec021](https://github.com/someone5678/revanced-patches/commit/42ec0218d829ea15759f83562d24588ce97cb646))
* **crunchyroll:** `enable-downloads` patch ([#1119](https://github.com/someone5678/revanced-patches/issues/1119)) ([d9d5e32](https://github.com/someone5678/revanced-patches/commit/d9d5e32740227fb98ca21be6a2f6a905d923f290))
* **crunchyroll:** remove `enable-downloads` patch ([2ac1546](https://github.com/someone5678/revanced-patches/commit/2ac15460f5734fc2c6d2d78d34083a8e6b2f7012))
* **custom-playback-speed:** max, min, granularity option ([a57c255](https://github.com/someone5678/revanced-patches/commit/a57c255ac5fece2e373b285c2054b442bafa2606))
* **debugging:** simplify patch name and description ([dd12dce](https://github.com/someone5678/revanced-patches/commit/dd12dcecf44bcdc4d72409451e8a23ad4c6ba63a))
* disable sponsorblock on shorts ([#439](https://github.com/someone5678/revanced-patches/issues/439)) ([72bb3d9](https://github.com/someone5678/revanced-patches/commit/72bb3d91a18614be0cc12c0bb46958e55f084139))
* display metadata for each signature in `SignatureChecker` ([736a71f](https://github.com/someone5678/revanced-patches/commit/736a71fac21a32dbb1eef9c3a9f0d3005e7d9ca0))
* **downloads:** missing package installation request ([661d8c9](https://github.com/someone5678/revanced-patches/commit/661d8c9430b212699b42241b3f0cac82073f6594))
* explicit support for YouTube v17.34.35 and v17.34.36 ([#527](https://github.com/someone5678/revanced-patches/issues/527)) ([ef5e28f](https://github.com/someone5678/revanced-patches/commit/ef5e28ff51a07881613bb1823068de261502be41))
* generate & upload dex files ([#18](https://github.com/someone5678/revanced-patches/issues/18)) ([e6f5355](https://github.com/someone5678/revanced-patches/commit/e6f53553a98c164c4eb926fb273358ed506e00a4))
* generate dex files using gradle task ([c34c1be](https://github.com/someone5678/revanced-patches/commit/c34c1be21f50b4f720a7cd81e0dfe5ef6330caab))
* get required register dynamically ([0924ca2](https://github.com/someone5678/revanced-patches/commit/0924ca2ad30ae865dcc0fd484cb0da517e827352))
* **hexeditor:** `disable-ads` patch ([#973](https://github.com/someone5678/revanced-patches/issues/973)) ([6eb7e20](https://github.com/someone5678/revanced-patches/commit/6eb7e2081b31bf6d2fed2594fa00f27e7b356eae))
* hide watermark support for 17.25.34 ([#87](https://github.com/someone5678/revanced-patches/issues/87)) ([0cdb65b](https://github.com/someone5678/revanced-patches/commit/0cdb65bbb3e7b9d75eb393ee87e3718bcd6af4b3))
* **iconpackstudio:** `unlock-pro` patch ([#1047](https://github.com/someone5678/revanced-patches/issues/1047)) ([826f6d0](https://github.com/someone5678/revanced-patches/commit/826f6d07861e2099ceab40335ef963b22cafd26e))
* implement `wide-searchbar` Patch ([#130](https://github.com/someone5678/revanced-patches/issues/130)) ([332f4d1](https://github.com/someone5678/revanced-patches/commit/332f4d12d06316d65db252a280fe1f263e65c3a8))
* Initial commit ([bee5f2f](https://github.com/someone5678/revanced-patches/commit/bee5f2faed882271ed059b0435e6e1aa91f93dbd))
* integrations patch ([19c0b0d](https://github.com/someone5678/revanced-patches/commit/19c0b0d194bb97c7248ea7a9b081176961653b9d))
* issue templates ([b82b0aa](https://github.com/someone5678/revanced-patches/commit/b82b0aad88b7ab9d86f1bcc8e007f6a76a9aa1a5))
* link packages to Google PlayStore ([#1272](https://github.com/someone5678/revanced-patches/issues/1272)) ([97892e0](https://github.com/someone5678/revanced-patches/commit/97892e01044c74916375aeebcc094d3304e14f4e))
* make resource mapping patch aware of types ([#77](https://github.com/someone5678/revanced-patches/issues/77)) ([188491a](https://github.com/someone5678/revanced-patches/commit/188491a707abccc1164413f075d8a66c145a1455))
* migrate to breaking changes of patcher ([d9147cd](https://github.com/someone5678/revanced-patches/commit/d9147cd60c0c25d0c5cc05409b8889dfacd89af9))
* migrate to dalvik patches ([e088c67](https://github.com/someone5678/revanced-patches/commit/e088c671081bcf75586ccc1c4bdbed9366e93874))
* MinimizedPlayback, CreateButtonRemover ([cc08c6c](https://github.com/someone5678/revanced-patches/commit/cc08c6c3d38879dd4672ec671631b34aa2e3cc77))
* **moneymanager:** `unlock-premium` patch ([#1173](https://github.com/someone5678/revanced-patches/issues/1173)) ([d0f2464](https://github.com/someone5678/revanced-patches/commit/d0f2464c10ed8e71ef76411bc133efe34288e5cd))
* **music:** bump compatibility to v5.34.51 ([4b8876c](https://github.com/someone5678/revanced-patches/commit/4b8876c0fd6d348a6a4cf0d23fc020489a7f163a))
* **myexpenses:** `unlock-pro` patch ([#1120](https://github.com/someone5678/revanced-patches/issues/1120)) ([96f4ed6](https://github.com/someone5678/revanced-patches/commit/96f4ed6fe1354b51b8e9ce974ae436975f6a634e))
* **nyx:** `unlock-pro` patch ([#1004](https://github.com/someone5678/revanced-patches/issues/1004)) ([167b4c7](https://github.com/someone5678/revanced-patches/commit/167b4c70a93e475a1e8d9b55fb6dcf946f3b36e8))
* OldQualityLayout, HideSuggestions, HideReels, EnableSeekbarTapping ([04a7cff](https://github.com/someone5678/revanced-patches/commit/04a7cfff20d2734b1c92713de4e7e08a3b93ee85))
* patch requests issue template ([#467](https://github.com/someone5678/revanced-patches/issues/467)) ([5857cde](https://github.com/someone5678/revanced-patches/commit/5857cde65292c0d6e3d8c5141e056cc5d711c5f0)), closes [revanced/revanced-patches#463](https://github.com/revanced/revanced-patches/issues/463)
* Patches for YouTube Music ([b60c9d3](https://github.com/someone5678/revanced-patches/commit/b60c9d33b611bb4d5b55bb419652bc14b0309792))
* **predictive-back-gesture:** exclude by default ([176d34b](https://github.com/someone5678/revanced-patches/commit/176d34b2ff92d0eb627dad86ad87f559df3db815))
* remove `force-vp9-codec` patch ([#287](https://github.com/someone5678/revanced-patches/issues/287)) ([e428978](https://github.com/someone5678/revanced-patches/commit/e42897801b20e7439969954753e2c15c85eb41b5))
* remove compatibility for YouTube  v17.41.37 ([#886](https://github.com/someone5678/revanced-patches/issues/886)) ([211fe9a](https://github.com/someone5678/revanced-patches/commit/211fe9a2498f0b5964f09457f268c57f13a53038))
* remove obsolete patch `Hide suggestions patch` ([e65c6f2](https://github.com/someone5678/revanced-patches/commit/e65c6f240ed23a54271d20a90fc57ec65cafc02d))
* remove partially complete patch ([2fffa4e](https://github.com/someone5678/revanced-patches/commit/2fffa4e17cceb87f22d223a66ae663796a5077cd))
* section `acknowledgements` for issue templates ([f992251](https://github.com/someone5678/revanced-patches/commit/f9922518cc75f4b2649fa6e89af00a93091c8f23))
* set the correct theme of the settings screen ([70d850c](https://github.com/someone5678/revanced-patches/commit/70d850cf295d306b0de9419efe6a4bbf3857d3a0))
* setting for downloader package name ([fb342b2](https://github.com/someone5678/revanced-patches/commit/fb342b26890d306bf0d4e754f034289e56173c3d))
* **sleepasandroid:** `unlock-premium` patch ([#1172](https://github.com/someone5678/revanced-patches/issues/1172)) ([40ef51c](https://github.com/someone5678/revanced-patches/commit/40ef51c3c46b5ab963dde47e3fc07ef5fedba6e9))
* **sleepasandroid:** remove `unlock-premium` patch ([#1253](https://github.com/someone5678/revanced-patches/issues/1253)) ([414f503](https://github.com/someone5678/revanced-patches/commit/414f503e493f2dc27edf134f5db723da77636d81))
* sort README patch table by amount of patches per package ([47fa865](https://github.com/someone5678/revanced-patches/commit/47fa8652447e4e4180ee88afd3e8026c1c74c3b9))
* **sponsorblock:** string for response error code 400 ([#512](https://github.com/someone5678/revanced-patches/issues/512)) ([f2da074](https://github.com/someone5678/revanced-patches/commit/f2da074492ce6a4a6c5de519f23b7378fca4fb55))
* **tasker:** `unlock-license` patch ([#1339](https://github.com/someone5678/revanced-patches/issues/1339)) ([78a43b8](https://github.com/someone5678/revanced-patches/commit/78a43b8abd972172eab99519dfa636ce77d9e64f))
* Theme Patch ([#440](https://github.com/someone5678/revanced-patches/issues/440)) ([ae145ab](https://github.com/someone5678/revanced-patches/commit/ae145ab3b9eae7c43f7c7ef48c8285243295bc89))
* **theme:** arbitrary background color for dark theme ([08b48b2](https://github.com/someone5678/revanced-patches/commit/08b48b2bb4ebfd282f5165d4bcb65d6a35db503b))
* **theme:** arbitrary background color for light theme  ([#565](https://github.com/someone5678/revanced-patches/issues/565)) ([58e9478](https://github.com/someone5678/revanced-patches/commit/58e94788b7ce6bea1e8a977b44fc08f95db54c79))
* **ticktick:** `unlock-themes` patch ([#1028](https://github.com/someone5678/revanced-patches/issues/1028)) ([ade2263](https://github.com/someone5678/revanced-patches/commit/ade22636da89886bf5b2e36130d0fb507f424e09))
* **tiktok-download:** custom download path ([#479](https://github.com/someone5678/revanced-patches/issues/479)) ([781f894](https://github.com/someone5678/revanced-patches/commit/781f8949afb78dc6fff75553fef8a9dc5504e1c0))
* **tiktok:** `sim-spoof` patch ([#1088](https://github.com/someone5678/revanced-patches/issues/1088)) ([7fe0a5b](https://github.com/someone5678/revanced-patches/commit/7fe0a5b912ae368f27b72695bc20111e5aa0cbb6))
* **tiktok:** `tiktok-web-login` patch ([#593](https://github.com/someone5678/revanced-patches/issues/593)) ([7269014](https://github.com/someone5678/revanced-patches/commit/72690147623f6fabe96c5499b2020da22576bcac))
* **tiktok:** adapt `tiktok-download` with `tiktok-settings`. ([#586](https://github.com/someone5678/revanced-patches/issues/586)) ([301e72e](https://github.com/someone5678/revanced-patches/commit/301e72e816a2e3178a6a4c2bb4a5d0f69ae736a3))
* **twitch/block-embedded-ads:** `block-embedded-ads` patch ([#1166](https://github.com/someone5678/revanced-patches/issues/1166)) ([018606e](https://github.com/someone5678/revanced-patches/commit/018606e9832c43836b6b8f4fbd623adb8876d162))
* **twitch/block-embedded-ads:** `block-embedded-ads` patch support ([#1160](https://github.com/someone5678/revanced-patches/issues/1160)) ([ae7bdfd](https://github.com/someone5678/revanced-patches/commit/ae7bdfdf9f667ebeb88f767ffe91c59482971d1d))
* **twitch/show-deleted-messages:** `show-deleted-messages` patch ([#1030](https://github.com/someone5678/revanced-patches/issues/1030)) ([34c73b7](https://github.com/someone5678/revanced-patches/commit/34c73b762f58bd6c8fefe0e196528756a495e3bf))
* **twitch:** `block-audio-ads` patch ([#1041](https://github.com/someone5678/revanced-patches/issues/1041)) ([1ce0625](https://github.com/someone5678/revanced-patches/commit/1ce0625a432b271566cb21d0f0a6e6d82df3ca31))
* **twitch:** `block-video-ads` patch  ([#1040](https://github.com/someone5678/revanced-patches/issues/1040)) ([0ac1dc5](https://github.com/someone5678/revanced-patches/commit/0ac1dc5e3f4daedd6ca61caa232dd5041f7fe0fd))
* **twitch:** `debug-mode` patch ([#1031](https://github.com/someone5678/revanced-patches/issues/1031)) ([ff59f15](https://github.com/someone5678/revanced-patches/commit/ff59f15e594b8e205be04e3c03d052afc9f8b567))
* **twitch:** `settings` patch ([#1075](https://github.com/someone5678/revanced-patches/issues/1075)) ([4b6ec32](https://github.com/someone5678/revanced-patches/commit/4b6ec32d41229b6a596c576988080bffb7ab9022))
* **twitch:** ˋintegrationsˋ  dependency patch ([#1074](https://github.com/someone5678/revanced-patches/issues/1074)) ([5179e7a](https://github.com/someone5678/revanced-patches/commit/5179e7a0f8716257064f5cc7985295f0e6bc55d2))
* **twitch:** remove `block-embedded-ads` patch ([#1164](https://github.com/someone5678/revanced-patches/issues/1164)) ([a43d149](https://github.com/someone5678/revanced-patches/commit/a43d149660cc88e0f3249c2866d48a4902c8b6c5))
* **twitch:** settings for patches ([#1142](https://github.com/someone5678/revanced-patches/issues/1142)) ([5c8fa2c](https://github.com/someone5678/revanced-patches/commit/5c8fa2c2bf8c9bbfbfa1d4afaddfd165c30bda91))
* twitter `timeline-ads` patch ([#222](https://github.com/someone5678/revanced-patches/issues/222)) ([f16e67f](https://github.com/someone5678/revanced-patches/commit/f16e67fc75c9c3505ff875a216ce7e868022075e))
* **twitter/timeline-ads:** add clarifying notice to description ([0eca2af](https://github.com/someone5678/revanced-patches/commit/0eca2af1a4a688903c61ff6469ffea90c60f06a6))
* **twitter:** `hide-views-stats` patch ([#1371](https://github.com/someone5678/revanced-patches/issues/1371)) ([2f04a06](https://github.com/someone5678/revanced-patches/commit/2f04a06e3b782931870d973fd0937f8731062f12))
* update MicroG patch to latest version ([c24f806](https://github.com/someone5678/revanced-patches/commit/c24f8063a04f89aea2d2f7087a435738de7dfeae))
* update patches to latest version ([bad25de](https://github.com/someone5678/revanced-patches/commit/bad25dec1d73137f8b7a1bf4daaceb2279b4d48c))
* updated all patches to support v17.22.36 of `com.android.google.youtube` ([e12dc11](https://github.com/someone5678/revanced-patches/commit/e12dc11b670c2b0c414741616e0a646e8421e418))
* use `install` mode by default ([c2b2993](https://github.com/someone5678/revanced-patches/commit/c2b299336a984d66a2d066e5ebe9c4f9bee5c2aa))
* use supplier instead of KClass ([08af6e5](https://github.com/someone5678/revanced-patches/commit/08af6e54af79ef9ef4fb3372a348ce9b6fba4d20))
* use supplier instead of KClass ([91aa019](https://github.com/someone5678/revanced-patches/commit/91aa019f8d3d87fbf7affeb7abc2b02ba87af5c3))
* v17.29.34 compatibility for `downloads` patch ([#374](https://github.com/someone5678/revanced-patches/issues/374)) ([bd01704](https://github.com/someone5678/revanced-patches/commit/bd017045eb8c05de396828e3e5976c099dae33ff))
* **windyapp:** `unlock-pro` patch ([#1118](https://github.com/someone5678/revanced-patches/issues/1118)) ([6159b26](https://github.com/someone5678/revanced-patches/commit/6159b2661483d74eb9ca7202646081a0904378a6))
* **youtube-music:** bump compatibility to 5.36.51 ([c4a3099](https://github.com/someone5678/revanced-patches/commit/c4a3099c1ca39431fba9beb94cc2b43e260561d9))
* **youtube-music:** bump patches compatibility to v5.31.50 ([#962](https://github.com/someone5678/revanced-patches/issues/962)) ([961ebfb](https://github.com/someone5678/revanced-patches/commit/961ebfbd8f305bdf3275f283e9ecbe23d2b25c56))
* **youtube/comments:** hide shorts comments button ([#866](https://github.com/someone5678/revanced-patches/issues/866)) ([0d8d180](https://github.com/someone5678/revanced-patches/commit/0d8d180fbf52866542687def3bfbf74c2f66525a))
* **youtube/copy-video-url:** match icon style with native icon ([#1419](https://github.com/someone5678/revanced-patches/issues/1419)) ([e89e54c](https://github.com/someone5678/revanced-patches/commit/e89e54c316a2d99195d2b79e9176d34f6de0113c))
* **youtube/debugging:** include by default & add option to debug on Android ([3865add](https://github.com/someone5678/revanced-patches/commit/3865add7995dc039a239ed02ab802152c7b9430f))
* **youtube/debugging:** print stack traces ([f3dcde6](https://github.com/someone5678/revanced-patches/commit/f3dcde6842de08c7452b73e1daf602fdfa87b511))
* **youtube/debugging:** use more suitable preference title ([c2538f3](https://github.com/someone5678/revanced-patches/commit/c2538f3ff94c8054e548bebf37335fc130d615aa))
* **youtube/enable-wide-searchbar:** bump compatibility to v17.45.36 ([47cf235](https://github.com/someone5678/revanced-patches/commit/47cf235abc59d13db4130fdb77c0bdcf63498cc2))
* **youtube/general-ads-patch:** hide channel member shelf ([#1380](https://github.com/someone5678/revanced-patches/issues/1380)) ([ce2b104](https://github.com/someone5678/revanced-patches/commit/ce2b104f508f1581ec531446d60bd3d41dafbd2c))
* **youtube/general-ads-patch:** hide guidelines for subscriber ([#1352](https://github.com/someone5678/revanced-patches/issues/1352)) ([2d10932](https://github.com/someone5678/revanced-patches/commit/2d1093251d5d50b476ca44f76acb9a8597b37aea))
* **youtube/general-ads:** check for ad in identifier ([47fb33b](https://github.com/someone5678/revanced-patches/commit/47fb33b5708084b89ea0712300aaee952dfa9243))
* **youtube/general-ads:** custom component filter ([fd6b3b7](https://github.com/someone5678/revanced-patches/commit/fd6b3b77c5bdd66da72e1c3fb81b301ffe57216f))
* **youtube/general-ads:** do not hide community posts by default ([147398b](https://github.com/someone5678/revanced-patches/commit/147398ba504b9efde02536e904f7c7b43beaa52b))
* **youtube/general-ads:** hide chapter teaser under videos ([5b6c8b5](https://github.com/someone5678/revanced-patches/commit/5b6c8b58e93d6dcfe2d46d039a785c259557cbfd))
* **youtube/general-ads:** hide gray separators ([5cc5cc4](https://github.com/someone5678/revanced-patches/commit/5cc5cc4ec986e3d956f9733388a8b3bcca30e8b3))
* **youtube/general-ads:** hide self sponsored cards ([b3eec46](https://github.com/someone5678/revanced-patches/commit/b3eec46ee48872ba9b3ce3c7f46276622a865f3f))
* **youtube/general-ads:** hide shorts in search ([6d7c10b](https://github.com/someone5678/revanced-patches/commit/6d7c10b41309720786def04a051b801cc26f9feb))
* **youtube/general-ads:** normalize switch names ([fb3d3f5](https://github.com/someone5678/revanced-patches/commit/fb3d3f5cb228066990b9eb2b921c273b7def5b6b))
* **youtube/hdr-auto-brightness:** increase strength of fingerprint ([1ee464f](https://github.com/someone5678/revanced-patches/commit/1ee464fddb6cdc470b8dc8102d7c092a8a515808))
* **youtube/hide-create-button:** bump compatibility to v17.45.36 ([1ca09ff](https://github.com/someone5678/revanced-patches/commit/1ca09ff63e9049b6636ed74bed7736d5a6947378))
* **youtube/hide-mix-playlists:** hide in video suggestions ([#854](https://github.com/someone5678/revanced-patches/issues/854)) ([96fc24e](https://github.com/someone5678/revanced-patches/commit/96fc24e35201e618b1c82755b2c29acad5756f86))
* **youtube/hide-shorts-button:** bump compatibility to v17.45.36 ([18ce2cb](https://github.com/someone5678/revanced-patches/commit/18ce2cb08adffd098be033c3d6ed16f73b959f2a))
* **youtube/microg-support:** handle availability of Vanced MicroG ([81db614](https://github.com/someone5678/revanced-patches/commit/81db6145ebe4dcdb6289807f27a0cd186c881712))
* **youtube/remember-video-quality:** remember current quality option ([e992c66](https://github.com/someone5678/revanced-patches/commit/e992c667cfea56c5c8cc0a9907ed3abcc56638df))
* **youtube/remember-video-quality:** remember the quality until changed by default ([3a80092](https://github.com/someone5678/revanced-patches/commit/3a800928bb9a9bb119846926450da0c3f37cae0e))
* **youtube/return-youtube-dislike:** better formatting and LTR support  ([#1370](https://github.com/someone5678/revanced-patches/issues/1370)) ([fd0fe1c](https://github.com/someone5678/revanced-patches/commit/fd0fe1c86ca99e395d340e85f4f1eb7b221e90ea))
* **youtube/return-youtube-dislike:** compatibility for old and new button layout ([f96b674](https://github.com/someone5678/revanced-patches/commit/f96b674f497e2a98c867c9fb030ad73e397fdbf2))
* **youtube/return-youtube-dislike:** debug connection statistics, toast on error, high priority background threads ([#1320](https://github.com/someone5678/revanced-patches/issues/1320)) ([30273a9](https://github.com/someone5678/revanced-patches/commit/30273a9bbdd40453baeb09f26ac9d218569a3e71))
* **youtube/return-youtube-dislike:** improve settings labels ([#1203](https://github.com/someone5678/revanced-patches/issues/1203)) ([6080d9b](https://github.com/someone5678/revanced-patches/commit/6080d9b42c1be578582cb04e9faac852c433d904))
* **youtube/return-youtube-dislike:** show dislike as a percentage ([#1185](https://github.com/someone5678/revanced-patches/issues/1185)) ([55cf0a8](https://github.com/someone5678/revanced-patches/commit/55cf0a8ba62c737692c8e2f905c746261ae2027f))
* **youtube/return-youtube-dislike:** simplify preference descriptions ([#1216](https://github.com/someone5678/revanced-patches/issues/1216)) ([514b5da](https://github.com/someone5678/revanced-patches/commit/514b5da9a7de6f8d0b0d00ec6269f836df3e9333))
* **youtube/sponsorblock:** skip segments once automatically ([#907](https://github.com/someone5678/revanced-patches/issues/907)) ([40b15d0](https://github.com/someone5678/revanced-patches/commit/40b15d0acb2010112514af2970bedabfa2000151))
* **youtube/theme:** add option to color the seekbar ([53b91fe](https://github.com/someone5678/revanced-patches/commit/53b91fe2b5a41f1a63deec8d919f2a1bc1cae12a))
* **youtube/theme:** exclude the patch by default ([3d5666f](https://github.com/someone5678/revanced-patches/commit/3d5666fc08c6362cf5ead641b47a84dcf7c059c1))
* **youtube/theme:** extend theming to splash screen ([#769](https://github.com/someone5678/revanced-patches/issues/769)) ([800b82e](https://github.com/someone5678/revanced-patches/commit/800b82ed747f35248b58a77361e6784d1d1dc483))
* **youtube/theme:** include the patch by default ([c363997](https://github.com/someone5678/revanced-patches/commit/c3639975683fb0ca0e271e8fc3ef7fbf79f33414))
* **youtube/theme:** make amoled the default color for dark theme background" ([2b3be9b](https://github.com/someone5678/revanced-patches/commit/2b3be9ba753adbe0ca631f645e6b51eb8ca3f66a))
* **youtube/theme:** make dark the default color for dark theme background ([0dfb39b](https://github.com/someone5678/revanced-patches/commit/0dfb39b13d49f6ff1a4bbbed0bdbfa4e785c4e96))
* **youtube:** `copy-video-url` patch ([#1402](https://github.com/someone5678/revanced-patches/issues/1402)) ([bf982e8](https://github.com/someone5678/revanced-patches/commit/bf982e8d7765c2a89a5475b6db8b203a3ac4ddf9))
* **youtube:** `disable-zoom-haptics` patch ([#1079](https://github.com/someone5678/revanced-patches/issues/1079)) ([041adc9](https://github.com/someone5678/revanced-patches/commit/041adc981b714e514bc12748bf88d134b1308572))
* **youtube:** `hide-breaking-news-shelf` patch ([#1381](https://github.com/someone5678/revanced-patches/issues/1381)) ([38a9877](https://github.com/someone5678/revanced-patches/commit/38a987744fbb49c2b7d5d0e69297e95f5ee405c4))
* **youtube:** `hide-captions-button` patch ([#770](https://github.com/someone5678/revanced-patches/issues/770)) ([f70b2bd](https://github.com/someone5678/revanced-patches/commit/f70b2bd77da6c8465b6cb4c474a7c5f73522c0ab))
* **youtube:** `hide-mix-playlists` patch  ([#816](https://github.com/someone5678/revanced-patches/issues/816)) ([2280d86](https://github.com/someone5678/revanced-patches/commit/2280d86bc560d1a311fd50ee76b352b6435ee36a))
* **youtube:** `open-links-directly` patch ([#999](https://github.com/someone5678/revanced-patches/issues/999)) ([eae9359](https://github.com/someone5678/revanced-patches/commit/eae9359ebd164abe9fce12cd058795ac44e9ccb2))
* **youtube:** `remove-player-button-background` patch ([#855](https://github.com/someone5678/revanced-patches/issues/855)) ([fa9c291](https://github.com/someone5678/revanced-patches/commit/fa9c291cb1116c56187dba53e20b5951ee03d85d))
* **youtube:** bump patches compatibility to v17.41.37 ([#888](https://github.com/someone5678/revanced-patches/issues/888)) ([323e385](https://github.com/someone5678/revanced-patches/commit/323e385ae90f6f3d756301a96cae7c4ff8d2f779))
* **youtube:** bump patches compatibility to v17.43.36 ([#924](https://github.com/someone5678/revanced-patches/issues/924)) ([be07271](https://github.com/someone5678/revanced-patches/commit/be07271bb7d849b7558998596b2a3c9edef7dc25))
* **youtube:** bump patches compatibility to v17.45.36 ([a81e67a](https://github.com/someone5678/revanced-patches/commit/a81e67a966f85fe5d2d1a7b0705afd47b3a5223b))
* **youtube:** bump patches compatibility to v17.49.37 ([83ebc73](https://github.com/someone5678/revanced-patches/commit/83ebc731130d3d216ac4b815382d8f13548cf665))
* **youtube:** drop support for compatibility of old versions ([ab7193e](https://github.com/someone5678/revanced-patches/commit/ab7193e8d4c517ada9ff1c96e3aa9e06bb9810e9))


### Performance Improvements

* fix high battery consumption due to chromecast not working with `microg` ([dd8b01a](https://github.com/someone5678/revanced-patches/commit/dd8b01a5c5d75b00ea4d04ce35bc43942c1b0409))
* **general-ads:** hook pathBuilder ([e864c6e](https://github.com/someone5678/revanced-patches/commit/e864c6eef94ca3a1a38728f713dd7efd72058142))
* **resource-mapping:** map resources with multiple threads ([3e067ff](https://github.com/someone5678/revanced-patches/commit/3e067ff1a3d87a2041d7d732771f0b4748fe5a7c))


### Reverts

* Revert "Changed app name to ReVanced (#21)" (#24) ([70a48c5](https://github.com/someone5678/revanced-patches/commit/70a48c5f35cd236612352a1dbbf50487625e6e96)), closes [#21](https://github.com/someone5678/revanced-patches/issues/21) [#24](https://github.com/someone5678/revanced-patches/issues/24)
